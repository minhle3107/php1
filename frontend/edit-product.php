...
?>
<?php
    require_once "../backend/edit-product-process.php";
?>
<?php
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mb-4">
                        <h3 class='text-primary fw-bold m-0 text-center'>Edit Product</h3>
                        <?php if (!empty($errors)) : ?>
                        ...
                        <form method="post" action="edit-product.php" enctype="multipart/form-data">
	                        <div class="mb-3">
		                        <label for="flight_id" class="form-label">Product ID:</label>
	                        ...
	                        <div class="mb-3">
		                        ...
		                        <img class="" src="<?php echo $row['product_image']; ?>" alt="Old image" width="300" height="200">
	                        </div>
                            <div class="mb-3">
                                <label for="product_description" class="form-label">Product Description:</label>
                                <textarea class="form-control" id="product_description"
                                          name="product_description" value="<?php echo $row['product_description']; ?>" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="category_id" class="form-label">Category Name:</label>
                                <select class="form-select" id="category_id" name="category_id" value="<?php echo $row['category_id']; ?>" required>
                                    <option value="">Select an category</option>
                                    <?php
                                        $sql_categories = "SELECT * FROM categories";
                                        $result = mysqli_query($conn, $sql_categories);
                                        while ($categories = mysqli_fetch_assoc($result)) {
                                            $selected = ($categories['category_id'] == $row['category_id']) ? 'selected' : '';
                                            echo "<option value='{$categories['category_id']}' $selected>{$categories['category_name']}</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                            <button type="submit" class="btn btn-primary" name="editproduct">Update Now</button>
                        </form>
                        <br>
