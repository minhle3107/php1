...
?>
<?php
    require_once "../backend/edit-category-process.php";
?>
<?php
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mb-4">
                        <h3 class='text-primary fw-bold m-0 text-center'>Edit Category</h3>
                        <?php if (!empty($errors)) : ?>
                        ...
                        <form method="post" action="edit-category.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="category_id" class="form-label">Product ID:</label>
                                <input type="text" class="form-control" id="category_id" name="category_id" value="<?php echo $row['category_id']; ?>" readonly>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <p class="text-black fw-bold m-2">Old Image</p>
                                <input type="hidden" name="old_image" value="<?php echo $row['category_image']; ?>">
                                <img class="" src="<?php echo $row['category_image']; ?>" alt="Old image" width="300" height="200">
                            </div>
                            <div class="mb-3">
                                <label for="category_description" class="form-label">Category Description:</label>
                                <textarea class="form-control" id="category_description"
                                          name="category_description" value="<?php echo $row['category_description']; ?>" required></textarea>
                            </div>

                            <button type="submit" class="btn btn-primary" name="editcategory">Update Now</button>
                        </form>
                        <br>
                        <a href="category-list.php">Back to List</a>
