...
<?php
	require_once "../backend/delete-product-process.php";
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mb-4">
                        <h3 class='text-primary fw-bold m-0 text-center'>Delete Product</h3>
                        <?php
                            //	                        session_start();
                            if (!empty($errors)) {
                        ...
                        ?>
                        <h3 class='mt-3'>Are you sure you want to delete product <?php echo $row['product_name']; ?>?</h3>
                        <br>
                        <button class='btn btn-outline-info mx-2'><a class='text-decoration-none' href='delete-product.php?product_id=<?php echo $row['product_id']; ?>&confirm=1'>Confirm</a></button>
                        <button class='btn btn-danger'><a class='text-decoration-none text-white' href='index.php'>No</a></button>
                        <br>
                    </div>
                </div>
