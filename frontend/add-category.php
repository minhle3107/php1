...
?>
<?php
    require_once "../backend/add-category-process.php";
?>
<?php
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link active" href="add-category.php"><i
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mb-4">
                        <h3 class='text-primary fw-bold m-0 text-center'>Add Category</h3>
                        <?php
                            if (!empty($errors)) {
                        ...
                        <form method="post" action="add-category.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="category_description"
                                          name="category_description" value="" required></textarea>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary" name="addcategory">Add Now</button>
                        </form>
                        <br>
