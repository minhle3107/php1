<?php //require_once "../backend/getall.php"; ?>

<?php
	require_once "../backend/controllerUserData.php";
	require_once "../backend/category-list-process.php";
?>
<?php
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
	            ...
	            <li class="nav-item"><a class="nav-link active" href="category-list.php"><i
                ...
                <div class="row">
                    <?php
                        ...
                        if (isset($_GET['success'])) {
                            echo "<div class='alert alert-success'>Successful category information update</div>";
                        }
                    ?>
                    <?php
                        getAllCategories();
