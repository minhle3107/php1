...
<?php
    require_once "../backend/delete-category-process.php";
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mb-4">
                        <h3 class='text-primary fw-bold m-0 text-center'>Delete Category</h3>
                        <?php
                            //	                        session_start();
                            if (!empty($errors)) {
                        ...
                        ?>
                        <h3 class='mt-3'>Are you sure you want to delete category <?php echo $row['category_name']; ?>?</h3>
                        <br>
                        <button class='btn btn-outline-info mx-2'><a class='text-decoration-none' href='delete-category.php?category_id=<?php echo $row['category_id']; ?>&confirm=1'>Confirm</a></button>
                        <button class='btn btn-danger'><a class='text-decoration-none text-white' href='category-list.php'>No</a></button>
                        <br>
                    </div>
                </div>
